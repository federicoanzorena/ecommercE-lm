...
Uso: python -m backend.modules.seguridad.seed
"""
...
ROLES_POR_DEFECTO = {
    "superadmin": {
        "descripcion": "Administrador máximo; gestiona roles y otros administradores",
        "permisos": [
            "usuarios:ver",
            "usuarios:crear",
            "usuarios:editar",
    ...
    "admin": {
        "descripcion": "Administrador con CRUD de usuarios y catálogo",
        "permisos": [
            "usuarios:ver",
            "usuarios:crear",
            "usuarios:editar",
    ...
    "vendedor": {
        "descripcion": "Vendedor del catálogo",
        "permisos": [
            "productos:crear",
            "productos:editar",
            "productos:eliminar",
