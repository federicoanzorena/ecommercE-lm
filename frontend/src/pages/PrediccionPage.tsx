...
import { predecirDemanda } from "../api/predicciones";
...
function PrediccionPage() {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      ...
      {mutation.isSuccess && (
        <div className="mt-6 border border-cyan-400/30 bg-cyan-400/10 rounded-lg p-6 text-center">
          <p className="text-sm text-zinc-400 mb-1">Demanda estimada</p>
          <p className="text-4xl font-bold text-cyan-400">
            {mutation.data.cantidad_estimada}
          </p>
          <p className="text-sm text-zinc-400 mt-1">unidades</p>
        </div>
      )}
